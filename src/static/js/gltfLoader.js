...
import { RoughnessMipmapper } from "/static/three/examples/jsm/utils/RoughnessMipmapper.js";
...
function init() {
  ...
  new RGBELoader()
    ...
    .setPath("/static/three/examples/textures/")
    .load("royal_esplanade_1k.hdr", function (texture) {
      ...
      var loader = new GLTFLoader().setPath(
        "/static/three/examples/models/gltf/"
      );
